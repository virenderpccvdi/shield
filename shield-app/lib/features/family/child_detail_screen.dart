      ...
      child: ListView(
        ...
        children: [
          ...
          _NavCard(
            ...
            subtitle: 'Block categories and custom domain lists',
            color: ShieldTheme.primary,
          ...
          _NavCard(
            ...
            title: 'Safe Filters',
            subtitle: 'YouTube safe mode, safe search, social media blocks',
            color: const Color(0xFF00695C),
            onTap: () => context.go('/family/${widget.profileId}/safe-filters'),
          ),
          _NavCard(
            icon: Icons.history_rounded,
            title: 'Browsing History',
            subtitle: 'View all DNS queries — blocked and allowed',
            color: const Color(0xFF4527A0),
            onTap: () => context.go('/family/${widget.profileId}/browsing-history'),
          ),
          ...
          _NavCard(
            ...
            title: 'Time Limits',
            subtitle: 'Daily screen time budgets per category',
            color: ShieldTheme.warning,
          ...
          _NavCard(
            ...
            title: 'Homework Mode',
            subtitle: 'Timed focus session — blocks distractions',
            color: ShieldTheme.primaryDark,
            onTap: () => context.go('/family/${widget.profileId}/homework-mode'),
          ),
          _NavCard(
            icon: Icons.bedtime_rounded,
            title: 'Bedtime Lock',
            subtitle: 'Block internet during sleep hours',
            color: const Color(0xFF1A237E),
            onTap: () => context.go('/family/${widget.profileId}/bedtime'),
          ),
          _NavCard(
            ...
            color: ShieldTheme.success,
            onTap: () => context.go('/family/${widget.profileId}/approvals'),
          ),

          // ── 5. Reports & Insights ──────────────────────────────────────
          const SizedBox(height: 16),
          const _SectionLabel(label: 'Reports & Insights'),
          const SizedBox(height: 10),
          _NavCard(
            icon: Icons.bar_chart_rounded,
            title: 'Reports & Analytics',
            subtitle: 'Usage charts and weekly summaries',
            color: ShieldTheme.success,
          ...
          _NavCard(
            ...
            title: 'App Usage',
            subtitle: 'Per-app screen time breakdown',
            color: const Color(0xFF1B5E20),
            onTap: () => context.go('/family/${widget.profileId}/app-usage'),
          ),

          // ── 6. Rewards ─────────────────────────────────────────────────
          const SizedBox(height: 16),
          const _SectionLabel(label: 'Rewards & Rules'),
          const SizedBox(height: 10),
          _NavCard(
          ...
          _NavCard(
            ...
            title: 'Family Rules',
            subtitle: 'Create named household rules and guidelines',
    ...
    return ListView(
      ...
      children: [
        ...
        _NavCard(
          ...
          subtitle: 'Manage trusted contacts for SOS calls',
          color: ShieldTheme.danger,
          onTap: () => context.go('/family/$profileId/emergency-contacts'),
        ),
        _NavCard(
        ...
        _NavCard(
          ...
          title: 'Panic Alert Monitor',
          subtitle: 'Real-time SOS location tracking',
          color: ShieldTheme.danger,
          onTap: () => context.go('/alerts/panic'),
        ),
        const SizedBox(height: 16),
        ...
        _NavCard(
          ...
          color: ShieldTheme.warning,
          onTap: () => context.go('/family/$profileId/battery-alerts'),
        ),
        _NavCard(
          icon: Icons.psychology_rounded,
          title: 'AI Behavioral Insights',
          subtitle: 'Risk analysis and anomaly detection',
          color: ShieldTheme.primaryDark,
        ...
        _NavCard(
          icon: Icons.apps_rounded,
          title: 'App Usage',
          subtitle: 'See how much time is spent per app',
          color: const Color(0xFF1B5E20),
          onTap: () => context.go('/family/$profileId/app-usage'),
        ),
        const SizedBox(height: 16),
        const _SectionLabel(label: 'Full Reports'),
        const SizedBox(height: 10),
        _NavCard(
          icon: Icons.bar_chart_rounded,
          title: 'Detailed Reports',
          subtitle: 'Weekly usage charts and summaries',
          color: ShieldTheme.success,
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const _SectionLabel(label: 'Family'),
        const SizedBox(height: 10),
        _NavCard(
          icon: Icons.gavel_rounded,
          title: 'Family Rules',
          subtitle: 'Household guidelines and agreements',
          color: const Color(0xFF7B1FA2),
          onTap: () => context.go('/family/rules'),
        ),
      ],
