    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          background: `linear-gradient(135deg, #A78BFA 0%, ${adminAccent} 100%)`,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          boxShadow: `0 2px 8px ${alpha(adminAccent, 0.35)}`,
        }}>
          ...
          <Toolbar sx={{ minHeight: 60, gap: 0.5, px: { xs: 1.5, md: 2.5 } }}>
            ...
            <Box
              ...
              sx={{
                ...
                '&:hover': {
                  bgcolor: isDark ? alpha('#fff', 0.06) : alpha(adminAccent, 0.04),
                  borderColor: isDark ? alpha(adminAccent, 0.3) : alpha(adminAccent, 0.3),
                },
              }}
            >
              <Avatar sx={{
